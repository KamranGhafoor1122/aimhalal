                ...
                InkWell(
                  onTap: () async {
                    ...
                    AddressResult result =   await  showGoogleMapLocationPicker(
                      pinWidget: Icon(Icons.location_pin,color: Theme.of(context).accentColor,size: 55,),
                      pinColor: Colors.blue,
                      context: context,
                      addressPlaceHolder: "Search",
                      addressTitle: "",
                      apiKey: setting.value.googleMapsKey,
                      appBarTitle: "Find Address",
                      confirmButtonColor: Colors.blue,
                      confirmButtonText: "Done",
                      confirmButtonTextColor: Colors.black,
                      country:"us",
                      language:"en" ,
                      searchHint: "Search", initialLocation: LatLng(deliveryAddress.value?.latitude ?? 0, deliveryAddress.value?.longitude ?? 0),
                    );
